...
set_property IOSTANDARD LVCMOS33    [get_ports [list GCLK] ]

# ----------------------------------------------------------------------------
# JA Pmod - Bank 13
# ---------------------------------------------------------------------------- 
#set_property PACKAGE_PIN Y11  [get_ports {JA1}];  # "JA1"
set_property PACKAGE_PIN Y11  [get_ports {spi_rtl_ss_o_0[0]}]; 
#set_property PACKAGE_PIN AA11 [get_ports {JA2}];  # "JA2"
set_property PACKAGE_PIN AA11 [get_ports spi_rtl_io0_o];
#set_property PACKAGE_PIN Y10  [get_ports {JA3}];  # "JA3"
set_property PACKAGE_PIN Y10  [get_ports spi_rtl_io1_o];
#set_property PACKAGE_PIN AA9  [get_ports {JA4}];  # "JA4"
set_property PACKAGE_PIN AA9  [get_ports spi_rtl_sck_o];
