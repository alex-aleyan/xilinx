...
HD_PWD='C:/training/7_series_IO_resources/completed/verilog/ioserdes.runs/tx_pll_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tx_pll.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tx_pll.tcl
