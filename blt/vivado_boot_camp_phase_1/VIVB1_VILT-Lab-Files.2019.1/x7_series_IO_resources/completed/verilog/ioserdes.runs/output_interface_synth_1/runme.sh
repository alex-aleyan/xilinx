...
HD_PWD='C:/training/7_series_IO_resources/completed/verilog/ioserdes.runs/output_interface_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log output_interface.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source output_interface.tcl
