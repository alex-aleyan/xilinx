...
HD_PWD='C:/training/7_series_IO_resources/completed/verilog/ioserdes.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ioserdes.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ioserdes.tcl
