...
HD_PWD='C:/training/7_series_IO_resources/completed/verilog/ioserdes.runs/input_interface_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log input_interface.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source input_interface.tcl
