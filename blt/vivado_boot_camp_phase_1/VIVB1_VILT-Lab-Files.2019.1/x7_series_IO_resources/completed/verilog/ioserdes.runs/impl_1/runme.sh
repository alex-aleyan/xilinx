...
HD_PWD='C:/training/7_series_IO_resources/completed/verilog/ioserdes.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ioserdes.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ioserdes.tcl -notrace
