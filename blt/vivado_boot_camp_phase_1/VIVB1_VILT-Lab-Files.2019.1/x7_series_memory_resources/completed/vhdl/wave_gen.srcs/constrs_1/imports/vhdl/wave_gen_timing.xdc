...
set_input_delay   -clock clk_pin_p 1.25         [get_ports {lb_sel_pin rst_pin rxd_pin}]
set_input_delay   -clock clk_pin_p -min 1 [get_ports {lb_sel_pin rst_pin rxd_pin}]
set_output_delay  -clock clk_pin_p 1.25         [all_outputs]

# Path specific timing constraints
set_output_delay -clock clk_pin_p -clock_fall 0.5 [get_ports spi_clk_pin] -add_delay
