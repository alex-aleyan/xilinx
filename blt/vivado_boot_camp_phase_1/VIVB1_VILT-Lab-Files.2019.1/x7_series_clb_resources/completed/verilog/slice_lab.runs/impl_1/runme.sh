...
HD_PWD='C:/training/des_7/completed/clb_architecture/kintex7/verilog/slice_lab.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log slice_lab.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source slice_lab.tcl -notrace
