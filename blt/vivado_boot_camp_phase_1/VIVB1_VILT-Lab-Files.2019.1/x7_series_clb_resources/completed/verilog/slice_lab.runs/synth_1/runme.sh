...
HD_PWD='C:/training/des_7/completed/clb_architecture/kintex7/verilog/slice_lab.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log slice_lab.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source slice_lab.tcl
